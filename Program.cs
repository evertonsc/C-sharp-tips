...
public class Program
{
	private static void Main(string[] args)
	{
		...
		while (true)
		{
			...
			Console.WriteLine("1. Value tips");
			Console.WriteLine("2. Date tips");
			Console.WriteLine("3. File tips");
	...
	public void FileTips()
	{
		/****************************************************************************************************************************************************************
		* Note: Read all lines from a file.
		****************************************************************************************************************************************************************/
		Console.WriteLine("\n===================================================");
		Console.WriteLine("Reading all lines from a file:");

		string[] lines = File.ReadAllLines("Files/example.txt");
